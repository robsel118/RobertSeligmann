...
export const FlatIcon = styled(Bordered)<ButtonProps>`
    ...
    box-shadow: ${ props => props.pressed? props.theme.iconShadowPressed : props.theme.iconShadowFlat};
    &:hover {
      background: ${ props => props.pressed? props.theme.cardBackground : props.theme.cardBackgroundHover};
      box-shadow: ${ props => props.pressed? props.theme.cardShadowPressed : props.theme.cardShadowFlat};
    }
    ` 
